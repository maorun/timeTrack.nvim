...
local input_mock_ctrl = { -- Renamed from input_mock to avoid conflict if helper.lua had a var of same name
  prompts_called_with = {},
  texts_to_return = {},
  current_text_idx = 1,
  was_called_count = 0,
...
function select_mock_ctrl:get_prompt() return self.prompt end
function select_mock_ctrl:get_items() return self.items end
...
function weekday_select_mock_api_ctrl:get_show_called_with_options() return self.show_called_with_options end
...
function notify_mock_ctrl:get_message() return self.message end
function notify_mock_ctrl:get_level() return self.level end
function notify_mock_ctrl:get_opts() return self.opts end
function notify_mock_ctrl:get_all_calls() return self.all_calls end
...
function mock_helpers_content.reset_all_was_called_flags()
    if mock_helpers_content.input_mock.was_called_count then mock_helpers_content.input_mock.was_called_count = 0 end
    if mock_helpers_content.select_mock.was_called then mock_helpers_content.select_mock.was_called = false end
    if mock_helpers_content.weekday_select_mock.was_called then mock_helpers_content.weekday_select_mock.was_called = false end
    if mock_helpers_content.notify_mock.was_called then mock_helpers_content.notify_mock.was_called = false end
    if mock_helpers_content.notify_mock.all_calls then mock_helpers_content.notify_mock.all_calls = {} end
end
